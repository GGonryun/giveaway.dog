                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                      ...
                      <div className="flex flex-col space-y-1">
                        <span className="text-muted-foreground text-xs uppercase tracking-wide">Entries</span>
                        <div className="font-bold text-lg text-center text-blue-600">
                          {user.entries}
                        </div>
                      </div>
                      <div className="flex flex-col space-y-1">
                        <span className="text-muted-foreground text-xs uppercase tracking-wide">Signed up</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="font-medium">
                  {(users.reduce((sum, u) => sum + u.entries, 0) / users.length).toFixed(1)}
                </div>
              </div>
            </div>
          </div>
