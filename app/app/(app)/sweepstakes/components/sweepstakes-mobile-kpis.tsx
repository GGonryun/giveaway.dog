    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <Card>
        <CardContent className="p-3">
          <div className="text-center">
            <div className="text-xs font-medium text-muted-foreground mb-1">Total Entries</div>
            <div className="text-lg font-bold">{data.totalEntries.toLocaleString()}</div>
            <div className="flex items-center justify-center mt-1">
      ...
      <Card>
        <CardContent className="p-3">
          <div className="text-center">
            <div className="text-xs font-medium text-muted-foreground mb-1">Avg Conv Rate</div>
            <div className="text-lg font-bold">{data.avgConversionRate.toFixed(1)}%</div>
            <div className="flex items-center justify-center mt-1">
