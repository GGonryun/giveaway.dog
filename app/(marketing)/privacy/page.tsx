      ...
      <div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <Typography.Paragraph className="mb-6">
            ...
            create an account, set up a giveaway, or contact us for support.
            This includes your name, email address, payment information, and any
          ...
          <Typography.Paragraph className="mb-6">
            ...
            business, or serving our users, provided they agree to keep this
          ...
          <Typography.Paragraph className="mb-6">
            ...
            destruction. This includes encryption, secure server environments,
            and regular security audits. However, no method of transmission over
          ...
          <Typography.Paragraph className="mb-6">
            ...
            any material changes by posting the new policy on our platform and
