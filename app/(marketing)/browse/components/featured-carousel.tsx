...
const featuredGiveaways: FeaturedGiveaway[] = [
  {
    ...
    description: 'Win an incredible gaming setup including RTX 4090, mechanical keyboard, and more!',
  ...
  },
  {
    ...
    description: 'Latest MacBook Pro with M3 chip, perfect for creators and developers.',
  ...
  },
  {
    ...
    description: 'Explore the world with this amazing travel package to your dream destination.',
  ...
  return (
    <div className="space-y-4">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground text-lg">Don't miss out on these incredible prizes!</p>
      </div>
      ...
      >
        <CarouselContent>
          {featuredGiveaways.map((giveaway) => (
            <CarouselItem key={giveaway.id} className="md:basis-1/2 lg:basis-1/3">
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{giveaway.participantsCount.toLocaleString()} entries</span>
                    </div>
                  </div>
